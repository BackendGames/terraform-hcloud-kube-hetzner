module "kube-hetzner" {
  ...
  # * Your ssh public key
  ssh_public_key = file("./keys/id_hetzner.pub")
  ...
  ssh_private_key = file("./keys/id_hetzner")
  ...
  #
  # Example:
  lb_hostname = "cluster.backend.games"
  ...
  microos_x86_snapshot_id = "165246183"
  microos_arm_snapshot_id = "165246185"
